...
Z([3,'movie-score-wrapper data-v-22032092'])
Z([3,'__i0__'])
Z([3,'yellow'])
Z([[7],[3,'yellowScore']])
Z([3,'star-ico data-v-22032092'])
...
Z([[2,'==='],[[7],[3,'showNum']],[1,1]])
Z([3,'movie-score data-v-22032092'])
...
Z([3,'movieId'])
Z([3,'data-v-9fad6ed4'])
Z([3,'swiper-item-image data-v-9fad6ed4'])
Z([[6],[[7],[3,'item']],[3,'image']])
Z([3,'super-hot page-block data-v-9fad6ed4'])
Z([3,'hot-title-wrapper data-v-9fad6ed4'])
Z([3,'hot-ico data-v-9fad6ed4'])
Z([3,'../../static/icos/hot.png'])
Z([3,'hot-title data-v-9fad6ed4'])
Z([3,'热门超英'])
Z([3,'page-block hot data-v-9fad6ed4'])
Z([3,'true'])
Z([3,'__i1__'])
Z(z[7])
Z([[7],[3,'hotSuperheroList']])
Z([3,'id'])
Z([3,'single-poster data-v-9fad6ed4'])
Z([3,'poster-wrapper data-v-9fad6ed4'])
Z([3,'poster data-v-9fad6ed4'])
Z([[6],[[7],[3,'item']],[3,'cover']])
Z([3,'movie-name data-v-9fad6ed4'])
...
Z(z[17])
Z([3,'热门预告'])
Z([3,'hot-movies page-block data-v-9fad6ed4'])
Z([3,'__i2__'])
Z(z[7])
Z([[7],[3,'hotTrailerList']])
Z(z[24])
Z([3,'__e'])
Z([3,'hot-movie-single data-v-9fad6ed4'])
...
Z(z[17])
Z([3,'猜你喜欢'])
Z([3,'guess-u-like page-block data-v-9fad6ed4'])
Z([3,'gIndex'])
Z(z[7])
Z([[7],[3,'guessULikeList']])
Z(z[24])
Z([3,'single-like-movie data-v-9fad6ed4'])
Z([3,'movie-poster data-v-9fad6ed4'])
Z(z[28])
Z([3,'movie-desc data-v-9fad6ed4'])
Z([3,'movie-title data-v-9fad6ed4'])
...
Z([1,0])
Z([[2,'+'],[1,'2-'],[[7],[3,'gIndex']]])
Z([3,'movie-info data-v-9fad6ed4'])
Z([a,[[6],[[7],[3,'item']],[3,'basicInfo']]])
Z(z[76])
Z([a,[[6],[[7],[3,'item']],[3,'releaseDate']]])
Z(z[47])
Z([3,'movie-oper data-v-9fad6ed4'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'praiseMe']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[7],[3,'gIndex']])
Z([3,'praise-ico data-v-9fad6ed4'])
Z([3,'../../static/icos/praise.png'])
Z([3,'praise-me data-v-9fad6ed4'])
Z([3,'点赞'])
Z([[6],[[7],[3,'animationDataList']],[[7],[3,'gIndex']]])
Z([3,'praise-me animation-opacity data-v-9fad6ed4'])
Z([3,'+1'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'page page-fill data-v-8a862308'])
Z([3,'header data-v-8a862308'])
Z([[7],[3,'userIsLogin']])
Z([3,'data-v-8a862308'])
Z([3,'face data-v-8a862308'])
Z([[6],[[7],[3,'userInfo']],[3,'faceImage']])
Z(z[3])
Z(z[4])
Z([3,'/static/icos/108x108.png'])
Z(z[2])
Z([3,'info-wrapper data-v-8a862308'])
Z([3,'nickname data-v-8a862308'])
Z([a,[[6],[[7],[3,'userInfo']],[3,'nickname']]])
Z([3,'nav-info data-v-8a862308'])
Z([a,[[2,'+'],[1,'ID: '],[[6],[[7],[3,'userInfo']],[3,'id']]]])
Z(z[3])
Z(z[3])
Z([3,'../registLogin/registLogin'])
Z([3,'nickname regist-login data-v-8a862308'])
Z([3,'注册/登录'])
Z(z[2])
Z([3,'set-wrapper data-v-8a862308'])
Z([3,'__e'])
Z([3,'settings data-v-8a862308'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'page data-v-06a229a4'])
Z([3,'player data-v-06a229a4'])
Z([3,'movie data-v-06a229a4'])
Z([3,'myTrailer'])
Z([[6],[[7],[3,'trailerInfo']],[3,'poster']])
Z([[6],[[7],[3,'trailerInfo']],[3,'trailer']])
Z([3,'movie-info data-v-06a229a4'])
Z([3,'data-v-06a229a4'])
Z([[2,'+'],[1,'../cover/cover?cover\x3d'],[[6],[[7],[3,'trailerInfo']],[3,'cover']]])
Z([3,'cover data-v-06a229a4'])
Z([3,'aspectFit'])
Z([[6],[[7],[3,'trailerInfo']],[3,'cover']])
Z([3,'movie-desc data-v-06a229a4'])
Z([3,'title data-v-06a229a4'])
Z([a,[[6],[[7],[3,'trailerInfo']],[3,'name']]])
Z([3,'basic-info data-v-06a229a4'])
...
Z([3,'score-block data-v-06a229a4'])
Z([3,'big-score data-v-06a229a4'])
Z([3,'score-words data-v-06a229a4'])
Z([3,'综合评分'])
Z([3,'movie-score data-v-06a229a4'])
Z([a,[[6],[[7],[3,'trailerInfo']],[3,'score']]])
Z([3,'score-stars data-v-06a229a4'])
...
Z([3,'0'])
Z([3,'1'])
Z([3,'prise-counts data-v-06a229a4'])
Z([a,[[2,'+'],[[6],[[7],[3,'trailerInfo']],[3,'prisedCounts']],[1,' 人点赞']]])
Z([3,'line-wrapper data-v-06a229a4'])
Z([3,'line data-v-06a229a4'])
Z([3,'plots-block data-v-06a229a4'])
Z([3,'plots-title data-v-06a229a4'])
Z([3,'剧情介绍'])
Z([3,'plots-desc data-v-06a229a4'])
Z([a,[[6],[[7],[3,'trailerInfo']],[3,'plotDesc']]])
Z([3,'scroll-block data-v-06a229a4'])
Z(z[42])
Z([3,'演职人员'])
Z([3,'scroll-list data-v-06a229a4'])
Z([3,'staffIndex'])
Z([3,'director'])
Z([[7],[3,'directorArray']])
Z([3,'staffId'])
Z([3,'actor-wrapper data-v-06a229a4'])
Z([3,'__e'])
Z([3,'single-actor data-v-06a229a4'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'lookStaffs']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[7],[3,'staffIndex']])
Z(z[10])
Z([[6],[[7],[3,'director']],[3,'photo']])
Z([3,'actor-name data-v-06a229a4'])
Z([a,[[6],[[7],[3,'director']],[3,'name']]])
Z([3,'actor-role data-v-06a229a4'])
...
Z(z[84])
Z(z[55])
Z([3,'plot-image data-v-06a229a4'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'body data-v-5e0146be'])
Z([3,'__e'])
Z([3,'data-v-5e0146be'])
Z([[4],[[5],[[4],[[5],[[5],[1,'submit']],[[4],[[5],[[4],[[5],[[5],[1,'formSubmit']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'face-wapper data-v-5e0146be'])
Z([3,'face data-v-5e0146be'])
Z([3,'../../static/icos/default-face.png'])
Z([3,'info-wapper data-v-5e0146be'])
Z([3,'words-lbl data-v-5e0146be'])
Z([3,'账号'])
Z([3,'input data-v-5e0146be'])
Z([3,'username'])
Z([3,'请输入用户名'])
Z([3,'graywords'])
Z([3,'text'])
...
Z(z[14])
Z(z[15])
Z([3,'loginbutton data-v-5e0146be'])
Z([3,'submit'])
Z([3,'primary'])
Z([3,'注册登录'])
Z([3,'third-wapper data-v-5e0146be'])
Z([3,'third-line data-v-5e0146be'])
Z([3,'single-line data-v-5e0146be'])
Z([3,'line data-v-5e0146be'])
Z([3,'third-words data-v-5e0146be'])
Z([3,'第三方账号登录'])
Z(z[32])
Z(z[33])
Z([3,'third-icons-wapper data-v-5e0146be'])
Z(z[1])
Z([3,'third-icon data-v-5e0146be'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'page data-v-df163a6a'])
Z([3,'search-block data-v-df163a6a'])
Z([3,'search-ico-wrapper data-v-df163a6a'])
Z([3,'search-ico data-v-df163a6a'])
Z([3,'../../static/icos/search.png'])
Z([3,'__e'])
Z([3,'search-text data-v-df163a6a'])
Z([3,'search'])
Z([[4],[[5],[[4],[[5],[[5],[1,'confirm']],[[4],[[5],[[4],[[5],[[5],[1,'searchMovie']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'10'])
Z([3,'搜索预告'])
Z([3,'movie-list page-block data-v-df163a6a'])
Z([3,'__i0__'])
Z([3,'item'])
Z([[7],[3,'trailerList']])
Z([3,'id'])
Z([3,'movie-wrapper data-v-df163a6a'])
Z(z[5])
Z([3,'poster data-v-df163a6a'])
...
__wxAppCode__['components/trailerStars.wxss']=setCssToHead([".",[1],"movie-score-wrapper.",[1],"data-v-22032092 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; }\n.",[1],"movie-score-wrapper .",[1],"star-ico.",[1],"data-v-22032092 { width: ",[0,20],"; height: ",[0,20],"; margin-top: ",[0,6],"; }\n.",[1],"movie-score-wrapper .",[1],"star-score.",[1],"data-v-22032092 { font-size: 12px; color: dimgrey; margin-left: ",[0,8],"; }\n",],undefined,{path:"./components/trailerStars.wxss"});    
...
__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"carousel.",[1],"data-v-9fad6ed4 { width: 100%; height: ",[0,440],"; }\n.",[1],"carousel .",[1],"swiper-item-image.",[1],"data-v-9fad6ed4 { width: 100%; }\n.",[1],"super-hot.",[1],"data-v-9fad6ed4 { margin-top: ",[0,12],"; padding: ",[0,20],"; }\n.",[1],"super-hot .",[1],"hot-title-wrapper.",[1],"data-v-9fad6ed4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; }\n.",[1],"super-hot .",[1],"hot-title-wrapper .",[1],"hot-ico.",[1],"data-v-9fad6ed4 { width: ",[0,30],"; height: ",[0,30],"; margin-top: ",[0,15],"; }\n.",[1],"super-hot .",[1],"hot-title-wrapper .",[1],"hot-title.",[1],"data-v-9fad6ed4 { font-size: 20px; margin-left: ",[0,20],"; font-weight: bold; }\n.",[1],"hot.",[1],"data-v-9fad6ed4 { width: 100%; white-space: nowrap; }\n.",[1],"hot .",[1],"single-poster.",[1],"data-v-9fad6ed4 { display: inline-block; margin-left: ",[0,20],"; }\n.",[1],"hot .",[1],"single-poster .",[1],"poster-wrapper.",[1],"data-v-9fad6ed4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; }\n.",[1],"hot .",[1],"single-poster .",[1],"poster-wrapper .",[1],"poster.",[1],"data-v-9fad6ed4 { width: ",[0,200],"; height: ",[0,270],"; }\n.",[1],"hot .",[1],"single-poster .",[1],"poster-wrapper .",[1],"movie-name.",[1],"data-v-9fad6ed4 { width: ",[0,200],"; margin-top: ",[0,10],"; font-size: 14px; font-weight: bold; white-space: nowrap; overflow: hidden; -o-text-overflow: ellipsis; text-overflow: ellipsis; }\n.",[1],"hot-movies.",[1],"data-v-9fad6ed4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-flex-wrap: wrap; -ms-flex-wrap: wrap; flex-wrap: wrap; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; padding: 0 ",[0,20]," ",[0,20],"; }\n.",[1],"hot-movies .",[1],"hot-movie-single.",[1],"data-v-9fad6ed4 { width: ",[0,350],"; height: ",[0,220],"; margin-top: ",[0,10],"; }\n.",[1],"guess-u-like.",[1],"data-v-9fad6ed4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; }\n.",[1],"guess-u-like .",[1],"single-like-movie.",[1],"data-v-9fad6ed4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: justify; -webkit-justify-content: space-between; -ms-flex-pack: justify; justify-content: space-between; padding: ",[0,30]," ",[0,20],"; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-poster.",[1],"data-v-9fad6ed4 { width: ",[0,180],"; height: ",[0,240],"; border-radius: 3%; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-desc.",[1],"data-v-9fad6ed4 { width: ",[0,340],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-desc .",[1],"movie-title.",[1],"data-v-9fad6ed4 { white-space: nowrap; overflow: hidden; -o-text-overflow: ellipsis; text-overflow: ellipsis; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-desc .",[1],"movie-info.",[1],"data-v-9fad6ed4 { color: #808080; font-size: 14px; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-oper.",[1],"data-v-9fad6ed4 { width: ",[0,140],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; border-left: dashed 2px #808080; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-oper .",[1],"praise-ico.",[1],"data-v-9fad6ed4 { width: ",[0,40],"; height: ",[0,40],"; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-oper .",[1],"praise-me.",[1],"data-v-9fad6ed4 { font-size: 14px; color: #feab2a; -webkit-align-self: center; -ms-flex-item-align: center; align-self: center; }\n.",[1],"guess-u-like .",[1],"single-like-movie .",[1],"movie-oper .",[1],"animation-opacity.",[1],"data-v-9fad6ed4 { font-weight: bold; opacity: 0; }\n",],undefined,{path:"./pages/index/index.wxss"});    
__wxAppCode__['pages/index/index.wxml']=$gwx('./pages/index/index.wxml');

__wxAppCode__['pages/me/me.wxss']=setCssToHead([".",[1],"page-fill.",[1],"data-v-8a862308 { width: 100%; height: 100%; }\n.",[1],"page-fill .",[1],"header.",[1],"data-v-8a862308 { padding: ",[0,120]," ",[0,30]," ",[0,40]," ",[0,30],"; background-color: #ffd655; background: url(http://122.152.205.72:88/group1/M00/00/03/CpoxxFwu_1OAYFAIAAAzO_Q1tPg693.png) repeat; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: start; -webkit-justify-content: flex-start; -ms-flex-pack: start; justify-content: flex-start; }\n.",[1],"page-fill .",[1],"header .",[1],"face.",[1],"data-v-8a862308 { width: ",[0,120],"; height: ",[0,120],"; border-radius: 50%; -webkit-flex-shrink: 0; -ms-flex-negative: 0; flex-shrink: 0; }\n.",[1],"page-fill .",[1],"header .",[1],"info-wrapper.",[1],"data-v-8a862308 { width: 80%; margin-left: ",[0,40],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: start; -webkit-justify-content: flex-start; -ms-flex-pack: start; justify-content: flex-start; }\n.",[1],"page-fill .",[1],"header .",[1],"info-wrapper .",[1],"nickname.",[1],"data-v-8a862308 { color: #6a5018; font-size: 18px; font-weight: bold; }\n.",[1],"page-fill .",[1],"header .",[1],"info-wrapper .",[1],"nav-info.",[1],"data-v-8a862308 { color: #a38eb2; font-size: 14px; margin-top: ",[0,10],"; }\n.",[1],"page-fill .",[1],"header .",[1],"set-wrapper.",[1],"data-v-8a862308 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: end; -webkit-justify-content: flex-end; -ms-flex-pack: end; justify-content: flex-end; width: 15%; }\n.",[1],"page-fill .",[1],"header .",[1],"set-wrapper .",[1],"settings.",[1],"data-v-8a862308 { width: ",[0,40],"; height: ",[0,40],"; }\n.",[1],"page-fill .",[1],"header .",[1],"regist-login.",[1],"data-v-8a862308 { margin-left: ",[0,60],"; margin-top: ",[0,30],"; }\n",],undefined,{path:"./pages/me/me.wxss"});    
...
__wxAppCode__['pages/movie/movie.wxss']=setCssToHead([".",[1],"player.",[1],"data-v-06a229a4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; background-color: black; }\n.",[1],"player .",[1],"movie.",[1],"data-v-06a229a4 { width: 100%; height: ",[0,440],"; }\n.",[1],"movie-info.",[1],"data-v-06a229a4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; background-color: #f7f4f9; padding: ",[0,40]," ",[0,20],"; }\n.",[1],"movie-info .",[1],"cover.",[1],"data-v-06a229a4 { width: ",[0,280],"; height: ",[0,380],"; }\n.",[1],"movie-info .",[1],"movie-desc.",[1],"data-v-06a229a4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; margin-left: ",[0,30],"; width: ",[0,400],"; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"title.",[1],"data-v-06a229a4 { font-size: 30px; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"basic-info.",[1],"data-v-06a229a4 { color: darkgray; font-size: 13px; line-height: ",[0,36],"; white-space: nowrap; overflow: hidden; -o-text-overflow: ellipsis; text-overflow: ellipsis; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"score-block.",[1],"data-v-06a229a4 { background-color: white; margin-top: ",[0,20],"; width: ",[0,360],"; height: ",[0,90],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: start; -webkit-justify-content: flex-start; -ms-flex-pack: start; justify-content: flex-start; padding: ",[0,20],"; -webkit-box-shadow: 3px 2px 10px #dedede; box-shadow: 3px 2px 10px #dedede; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"score-block .",[1],"big-score.",[1],"data-v-06a229a4 { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"score-block .",[1],"big-score .",[1],"score-words.",[1],"data-v-06a229a4 { font-size: 12px; color: gray; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"score-block .",[1],"big-score .",[1],"movie-score.",[1],"data-v-06a229a4 { font-size: 24px; font-weight: bold; margin-left: ",[0,8],"; color: orange; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"score-block .",[1],"score-stars.",[1],"data-v-06a229a4 { margin-left: ",[0,10],"; }\n.",[1],"movie-info .",[1],"movie-desc .",[1],"score-block .",[1],"score-stars .",[1],"prise-counts.",[1],"data-v-06a229a4 { font-size: 12px; color: gray; line-height: ",[0,44],"; }\n.",[1],"line-wrapper.",[1],"data-v-06a229a4 { padding: 0px ",[0,20],"; }\n.",[1],"line-wrapper .",[1],"line.",[1],"data-v-06a229a4 { height: 1px; background-color: #DBDBDA; }\n.",[1],"plots-block.",[1],"data-v-06a229a4 { background-color: #f7f4f9; padding: ",[0,20]," ",[0,40],"; }\n.",[1],"plots-block .",[1],"plots-title.",[1],"data-v-06a229a4 { font-size: 14px; color: gray; }\n.",[1],"plots-block .",[1],"plots-desc.",[1],"data-v-06a229a4 { margin-top: ",[0,10],"; font-size: 16px; }\n.",[1],"scroll-block.",[1],"data-v-06a229a4 { background-color: #f7f4f9; padding: ",[0,20]," ",[0,40],"; }\n.",[1],"scroll-block .",[1],"scroll-list.",[1],"data-v-06a229a4 { width: 100%; white-space: nowrap; margin-top: ",[0,20],"; }\n.",[1],"scroll-block .",[1],"scroll-list .",[1],"actor-wrapper.",[1],"data-v-06a229a4 { display: inline-block; }\n.",[1],"scroll-block .",[1],"scroll-list .",[1],"actor-wrapper .",[1],"single-actor.",[1],"data-v-06a229a4 { width: ",[0,170],"; height: ",[0,240],"; margin-right: ",[0,10],"; }\n.",[1],"scroll-block .",[1],"scroll-list .",[1],"actor-wrapper .",[1],"actor-name.",[1],"data-v-06a229a4 { width: ",[0,170],"; font-size: ",[0,15],"; text-align: center; white-space: nowrap; overflow: hidden; -o-text-overflow: ellipsis; text-overflow: ellipsis; }\n.",[1],"scroll-block .",[1],"scroll-list .",[1],"actor-wrapper .",[1],"actor-role.",[1],"data-v-06a229a4 { width: ",[0,170],"; font-size: ",[0,13],"; color: #A9A9A9; text-align: center; white-space: nowrap; overflow: hidden; -o-text-overflow: ellipsis; text-overflow: ellipsis; }\n.",[1],"scroll-block .",[1],"scroll-list .",[1],"plot-image.",[1],"data-v-06a229a4 { width: ",[0,220],"; height: ",[0,320],"; margin-right: ",[0,10],"; }\n",],undefined,{path:"./pages/movie/movie.wxss"});    
__wxAppCode__['pages/movie/movie.wxml']=$gwx('./pages/movie/movie.wxml');

__wxAppCode__['pages/registLogin/registLogin.wxss']=setCssToHead([".",[1],"body.",[1],"data-v-5e0146be { border-top: solid 1px #DBDBDA; padding: 0 ",[0,40],"; }\n.",[1],"face-wapper.",[1],"data-v-5e0146be { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; margin-top: ",[0,120],"; margin-bottom: ",[0,120],"; }\n.",[1],"face.",[1],"data-v-5e0146be { width: ",[0,120],"; height: ",[0,120],"; }\n.",[1],"info-wapper.",[1],"data-v-5e0146be { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; border-bottom: solid 1px #DBDBDA; padding-bottom: ",[0,20],"; margin-top: ",[0,40],"; }\n.",[1],"words-lbl.",[1],"data-v-5e0146be { color: #808080; }\n.",[1],"input.",[1],"data-v-5e0146be { width: ",[0,500],"; margin-left: ",[0,20],"; }\n.",[1],"graywords.",[1],"data-v-5e0146be { color: #EAEAEA; }\n.",[1],"loginbutton.",[1],"data-v-5e0146be { margin-top: 60px; width: 90%; }\nwx-button.",[1],"data-v-5e0146be::after { border: none; }\n.",[1],"third-wapper.",[1],"data-v-5e0146be { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: start; -webkit-justify-content: flex-start; -ms-flex-pack: start; justify-content: flex-start; margin-top: ",[0,60],"; }\n.",[1],"third-line.",[1],"data-v-5e0146be { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; }\n.",[1],"single-line.",[1],"data-v-5e0146be { padding: ",[0,25]," ",[0,20],"; -webkit-box-align: center; -webkit-align-items: center; -ms-flex-align: center; align-items: center; width: 25%; }\n.",[1],"line.",[1],"data-v-5e0146be { height: 1px; background-color: #A9A9A9; }\n.",[1],"third-words.",[1],"data-v-5e0146be { color: #A9A9A9; font-size: 13px; }\n.",[1],"third-icons-wapper.",[1],"data-v-5e0146be { margin-top: ",[0,30],"; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; }\n.",[1],"third-icon.",[1],"data-v-5e0146be { width: ",[0,60],"; height: ",[0,60],"; }\n.",[1],"third-btn-ico.",[1],"data-v-5e0146be { background-image: url(http://122.152.205.72:88/group1/M00/00/05/CpoxxFxFO-yAOjTaAAATCIZEzRU503.png); width: ",[0,60],"; height: ",[0,60],"; background-color: white; background-size: ",[0,60]," ",[0,60],"; background-repeat: no-repeat; border: none; padding: 0; }\n",],undefined,{path:"./pages/registLogin/registLogin.wxss"});    
__wxAppCode__['pages/registLogin/registLogin.wxml']=$gwx('./pages/registLogin/registLogin.wxml');

__wxAppCode__['pages/search/search.wxss']=setCssToHead([".",[1],"search-block.",[1],"data-v-df163a6a { position: fixed; top: 100; z-index: 9999; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; padding: 0 ",[0,20]," ",[0,20]," ",[0,20],"; background-color: #f8f8f8; }\n.",[1],"search-block .",[1],"search-ico-wrapper.",[1],"data-v-df163a6a { background-color: #eaeaea; display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: vertical; -webkit-box-direction: normal; -webkit-flex-direction: column; -ms-flex-direction: column; flex-direction: column; -webkit-box-pack: center; -webkit-justify-content: center; -ms-flex-pack: center; justify-content: center; padding: 0 ",[0,10],"; }\n.",[1],"search-block .",[1],"search-ico-wrapper .",[1],"search-ico.",[1],"data-v-df163a6a { width: ",[0,40],"; height: ",[0,40],"; }\n.",[1],"search-block .",[1],"search-text.",[1],"data-v-df163a6a { font-size: 14px; background-color: #eaeaea; height: ",[0,60],"; width: ",[0,650],"; }\n.",[1],"movie-list.",[1],"data-v-df163a6a { display: -webkit-box; display: -webkit-flex; display: -ms-flexbox; display: flex; -webkit-box-orient: horizontal; -webkit-box-direction: normal; -webkit-flex-direction: row; -ms-flex-direction: row; flex-direction: row; -webkit-box-pack: start; -webkit-justify-content: flex-start; -ms-flex-pack: start; justify-content: flex-start; -webkit-flex-wrap: wrap; -ms-flex-wrap: wrap; flex-wrap: wrap; padding: ",[0,100]," ",[0,10]," 0 ",[0,10],"; }\n.",[1],"movie-list .",[1],"movie-wrapper.",[1],"data-v-df163a6a { padding: ",[0,10]," ",[0,20],"; }\n.",[1],"movie-list .",[1],"movie-wrapper .",[1],"poster.",[1],"data-v-df163a6a { width: ",[0,200],"; height: ",[0,270],"; }\n",],undefined,{path:"./pages/search/search.wxss"});    
